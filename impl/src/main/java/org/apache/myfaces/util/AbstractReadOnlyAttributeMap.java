 ...
 */
public abstract class AbstractReadOnlyAttributeMap<V> extends AbstractMap<String, V>
{
    ...
    private abstract class AbstractAttributeSet<E> extends AbstractSet<E>
    {
        ...
        public boolean isEmpty()
        {
            return AbstractReadOnlyAttributeMap.this.isEmpty();
        }

        @Override
        public int size()
        {
            return AbstractReadOnlyAttributeMap.this.size();
        }

        @Override
        public void clear()
        {
            AbstractReadOnlyAttributeMap.this.clear();
        }
    }
    ...
    private final class KeySet extends AbstractAttributeSet<String>
    {
        ...
        {
            return AbstractReadOnlyAttributeMap.this.containsKey(o);
        }

        @Override
        public boolean remove(final Object o)
        {
            return AbstractReadOnlyAttributeMap.this.remove(o) != null;
        }
    ...
    private abstract class AbstractAttributeIterator<E> implements Iterator<E>
    {
        ...
        public void remove()
        {
            ...
            AbstractReadOnlyAttributeMap.this.remove(_currentKey);
        }
    ...
    private class ValuesIterator extends AbstractAttributeIterator<V>
    {
        ...
        {
            return AbstractReadOnlyAttributeMap.this.get(attributeName);
        }
    }
    ...
    private final class EntrySet extends AbstractAttributeSet<Entry<String, V>>
    {
        ...
        public boolean contains(final Object o)
        {
            ...
            return value.equals(AbstractReadOnlyAttributeMap.this.get(key));
        }
        ...
        public boolean remove(final Object o)
        {
            ...
            final Object key = entry.getKey();
            final Object value = entry.getValue();
            if (key == null || value == null || !value.equals(AbstractReadOnlyAttributeMap.this.get(key)))
            {
                return false;
            }

            return AbstractReadOnlyAttributeMap.this.remove(((Entry<String, V>)o).getKey()) != null;
        }
    }
    ...
    private final class EntrySetEntry implements Entry<String, V>
    {
        ...
        public V getValue()
        {
            return AbstractReadOnlyAttributeMap.this.get(_currentKey);
        }

        public V setValue(final V value)
        {
            return AbstractReadOnlyAttributeMap.this.put(_currentKey, value);
        }
