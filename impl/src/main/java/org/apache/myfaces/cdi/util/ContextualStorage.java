...
public class ContextualStorage implements Serializable
{
    ...
    {
        if (bean instanceof PassivationCapable capable && passivating)
        {
            // if the
            return capable.getId();
        }
    ...
    {
        if (beanKey instanceof String string && passivating)
        {
            // If the beanKey is a String, it was generated by PassivationCapable#getId().
            return beanManager.getPassivationCapableBean(string);
        }

        if (beanKey instanceof Contextual contextual)
        {
            return contextual;
        }
