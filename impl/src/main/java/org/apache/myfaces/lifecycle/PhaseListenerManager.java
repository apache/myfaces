...
class PhaseListenerManager
{
    ...
    PhaseListenerManager(Lifecycle lifecycle, FacesContext facesContext, List<PhaseListener> phaseListeners)
    {
    ...
    /** Bridge for test infrastructure that instantiates via reflection with PhaseListener[]. */
    PhaseListenerManager(Lifecycle lifecycle, FacesContext facesContext, PhaseListener[] phaseListeners)
    {
        this(lifecycle, facesContext, Arrays.asList(phaseListeners));
    }
