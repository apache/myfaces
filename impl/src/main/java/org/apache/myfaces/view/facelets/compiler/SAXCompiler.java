...
public final class SAXCompiler extends Compiler {
    ...
    private final static Pattern XML_DECLARATION = Pattern.compile("^<\\?xml.+?version=['\"](.+?)['\"](.+?encoding=['\"]((.+?))['\"])?.*?\\?>");
    
    /**
     * see https://issues.apache.org/jira/browse/MYFACES-4281
     */
    private final static List<String> SKIPPED_NAMESPACES = Arrays.asList("http://www.w3.org/1998/Math/MathML","http://www.w3.org/2000/svg","http://www.w3.org/1999/xlink");
    ...
    private static class CompilationHandler extends DefaultHandler implements LexicalHandler {
        ...
        public void startDTD(String name, String publicId, String systemId) throws SAXException {
            if (this.inDocument && !unit.getFaceletsProcessingInstructions().isConsumeXmlDocType()) {
                 ...
                 * sb.append("<!DOCTYPE ").append(name); if (publicId != null) {
                 * sb.append(" PUBLIC \"").append(publicId).append("\""); if
                 * (systemId != null) {
                 * sb.append(" \"").append(systemId).append("\""); } } else if
                 * (systemId != null) {
    ...
    /**
     * Like CompilationHandler but does not take into account everything outside
     * f:metadata tag
     * 
     * @since 2.0
     */
    private static class ViewMetadataHandler extends DefaultHandler implements LexicalHandler {
        ...
        public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
            if ((CoreLibrary.NAMESPACE.equals(uri) || CoreLibrary.ALIAS_NAMESPACE.equals(uri)) && this.uiRemoveCount <= 0) {
                if ("metadata".equals(localName)) {
    ...
    /**
     * Like CompilationHandler but does not take into account everything outside
     * cc:interface or cc:implementation tag.
     * 
     * Note inside cc:implementation it only takes into account
     * cc:insertChildren, cc:insertFacet and cc:renderFacet, all other tags,
     * comments or text are just skipped.
     * 
     * @since 2.0.1
     */
    private static class CompositeComponentMetadataHandler extends DefaultHandler implements LexicalHandler {
        ...
        public void endElement(String uri, String localName, String qName) throws SAXException {
            if (inCompositeInterface) {
                this.unit.popTag();
            } else if (inCompositeImplementation && (CompositeLibrary.NAMESPACE.equals(uri) || CompositeLibrary.ALIAS_NAMESPACE.equals(uri))) {
                if ("insertFacet".equals(localName) || "renderFacet".equals(localName) || "insertChildren".equals(localName)
        ...
        public void processingInstruction(String target, String data) throws SAXException {
            if (inDocument && inCompositeInterface && !unit.getFaceletsProcessingInstructions().isConsumeProcessingInstructions()) {
                StringBuffer sb = new StringBuffer(64);
                sb.append("<?").append(target).append(' ').append(data).append("?>\n");
                this.unit.writeInstruction(sb.toString());
            }
    ...
    protected FaceletHandler doCompileComponent(String taglibURI, String tagName, Map<String, Object> attributes) {
        ...
        boolean tagContainParams = (("include".equals(tagName) || "decorate".equals(tagName) || "composition".equals(tagName))
