...
import static org.apache.myfaces.view.facelets.PartialStateManagementStrategy.COMPONENT_ADDED_AFTER_BUILD_VIEW;
                        ...
                        currentHandler instanceof BehaviorHolderAttachedObjectHandler handler))
                {
                            ...
                            (eventName == null && isDefaultEvent))
                    {
                        ...
                        for (int j = 0, targetssize = targets.size(); j < targetssize; j++)
                        {
                            ...
                            if (UIComponent.isCompositeComponent(component))
                            {
                                if (currentTarget instanceof ClientBehaviorAttachedObjectTarget targetBehavior)
                                {
