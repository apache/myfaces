...
myfaces._impl.core._Runtime.extendClass("myfaces._impl.i18n.Messages_es", myfaces._impl.i18n.Messages, {
    ...
    ERR_VIEWSTATE:          "jsf.viewState: el valor del parámetro no es de tipo 'form'!",
    ...
    ERR_SOURCE_FUNC:        "el origen no puede ser una función (probablemente 'source' y evento no han sido definidos o son 'null'",
    ERR_EV_OR_UNKNOWN:      "Un objeto de tipo evento o desconocido debe ser pasado como segundo parámetro",
    ...
    ERR_PARAM_STR_RE:       "{0}: el parámetro {1} tiene que ser de tipo string o una expresión regular",
    ...
    ERR_EMPTY_RESPONSE:     "{0}: ¡La respuesta no puede ser de tipo 'null' o vacía!",
    ...
    ERR_PPR_INSERTBEFID:    "{0}: Error in PPR Insert, antes de 'id' o después de 'id' deben estar presentes",
    ERR_PPR_INSERTBEFID_1:  "{0}: Error in PPR Insert, antes de nodo con id {1} no existe en el documento",
    ERR_PPR_INSERTBEFID_2:  "{0}: Error in PPR Insert, después de nodo con id {1} no existe en el documento",
    ...
    ERR_REQ_FAILED_UNKNOWN: "La petición ha fallado con estado desconocido",
    ERR_REQU_FAILED:        "La petición ha fallado con estado {0} y razón {1}",
    UNKNOWN:                "DESCONOCIDO"
