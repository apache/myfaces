...
public class UIOutput extends UIComponentBase implements ValueHolder
{
    ...
    public void restoreState(FacesContext facesContext, Object state)
    {
        ...
        if (values.length == 2)
        {
            ...
            {
                //Full
                _converter = (Converter) restoreAttachedState(facesContext,values[1]);
            }
        }
    }
    ...
    private void _handleResourceDependency(FacesContext context, ResourceDependency annotation)
    {
        ...
        if (annotation != null)
        {
            ...
            {
                // Otherwise, if target is null, call UIViewRoot.addComponentResource(jakarta.faces.context.FacesContext,
